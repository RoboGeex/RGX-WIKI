    ...
    return (
        <div className={`relative w-full group ${className}`} onMouseDown={(e) => e.stopPropagation()}>
            ...
            >
                <EditorContent
                    editor={editor}
                    className="tiptap-caption-editor w-full text-center [&_.tiptap]:w-full [&_.tiptap]:text-center [&_.tiptap]:!min-h-0 [&_.tiptap]:!p-0 [&_.tiptap]:outline-none [&_p]:text-center [&_p]:w-full [&_p]:m-0 [&_p]:!text-base [&_p]:!text-gray-600 [&_p]:!leading-tight"
                />
            </div>
        </div>
    )
