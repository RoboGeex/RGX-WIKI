...
export default function WikiEditor() {
  ...
  const editorAr = useEditor({
    ...
    extensions: [
      ...
      CodeBlockLowlight.configure({ lowlight: lowlightInstance }),
      Video,
      Placeholder.configure({ placeholder: "«ﬂ » '/' ··≈œ—«Ã" }),
      SlashCommand,
    ],
    content: initialContentRef.current,
    editorProps: {
  ...
  async function publish() {
    ...
    const titleAr = meta.title_ar || meta.title_en || '⁄‰Ê«‰ €Ì— „ Ê›—'
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm">
            <div className="px-6 pt-6 pb-4 border-b text-sm text-gray-500">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-gray-400">Ì„ﬂ‰ﬂ «” Œœ«„ «·√„— <span className="px-1 rounded bg-gray-100">/</span> ··≈œ—«Ã</span>
              </div>
            </div>
            <div className="px-6 py-6 space-y-4">
