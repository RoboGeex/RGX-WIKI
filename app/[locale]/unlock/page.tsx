              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-2xl bg-white/75 shadow-inner ring-1 ring-white/70 focus:outline-none transition-all ${inputBorderClasses}`}
