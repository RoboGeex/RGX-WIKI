    ...
    <div className="mx-auto max-w-5xl px-6 py-10 space-y-8">
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2 lg:hidden">
          <Link href="/editor" className="text-xs uppercase tracking-widest text-gray-500 hover:text-gray-700">
            ← All wikis
          </Link>
        </div>
        {selectedKitSlug && (
          <div className="flex items-center gap-2">
            <Link href={`/editor/${wiki.slug}`} className="text-xs uppercase tracking-widest text-gray-500 hover:text-gray-700">
              ← Back to wiki
            </Link>
          </div>
        )}
